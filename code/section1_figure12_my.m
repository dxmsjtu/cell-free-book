...
x = 4:1:squareSide-4; y = 4:1:squareSide-4;
...
%Compute the combined channel gain from all antennas to the different sample points. We are considering a free-space propagation pathloss
