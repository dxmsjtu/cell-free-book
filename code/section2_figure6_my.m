...
% figure;hold on; box on; fontsize =32; LineWidth =4;
% plot(1:N,10*log10(eigenvalues_ULA_5),'rs--','LineWidth',LineWidth);
% plot(1:N,10*log10(eigenvalues_ULA_10),'bd-.','LineWidth',LineWidth);
% plot(1:N,10*log10(eigenvalues_ULA_20),'ko-','LineWidth',LineWidth);
% plot(1:N,10*log10(eigenvalues_uncorr),'k:','LineWidth',LineWidth);
% 
...
figure;hold on; box on; fontsize =28;
